 ...
 */
export abstract class NonNegativeIntegerNumberValueObject extends ValidatableIntegerNumberValueObject {
  /**
   ...
   */
  validate(this: NonNegativeIntegerNumberValueObject, value: number) {
    if (value < 0) {

import { IntegerNumberValueObject } from './integer-number.value-object';

/**
 * Abstract class representing a validatable number value object.
 */
export abstract class ValidatableIntegerNumberValueObject extends IntegerNumberValueObject {
  /**
